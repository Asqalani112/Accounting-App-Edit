...
class AccountController:
    ...
    def make_gl_entries(self, entries: list):
    ...
    def make_reverse_gl_entries(self, voucher_type, voucher_number):
        original_entries = frappe.get_all("GL Entry",
          filters={"voucher_type": voucher_type, "voucher_number": voucher_number},
          fields=["posting_date", "due_date", "party", "account", "debit_amount",
                  "credit_amount"]
          )
